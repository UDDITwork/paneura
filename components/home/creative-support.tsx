  ...
  const modalSections = [
    {
      ...
      description:
        "Pan Eura Automations transforms complex ideas into visually stunning narratives. Our diagrammatic approach ensures your message isn't just seen—it's understood and remembered.",
      image1:
        "https://www.northeastshop.com/cdn/shop/products/7_8a8135c0-3100-4db9-a8e7-c26293be50e5.jpg?v=1680943307&width=1920",
      image2:
        "https://cdn.dribbble.com/userupload/43106802/file/original-866775ba1aff2a90974437b30f22ee82.png?resize=1504x1128&vertical=center",
      color: "from-purple-500/20 to-blue-500/20",
    },
    {
      title: "From Concept to Creation",
      description:
        "Our design process evolves your raw concepts through a meticulous journey of refinement. We blend artistic vision with practical functionality to create designs that captivate.",
      image1:
        "https://freight.cargo.site/t/original/i/76baac0c1b91d41147390a985cabe07bb642f37f14b270ae54ce6825a6d3b9d8/process-book-02-copy.png",
      image2:
        "https://www.salonemilano.it/sites/default/files/styles/libero/public/2021-05/Ritratti-Grafici_01_dallas.jpg.webp?itok=JwFIL-Hm",
      color: "from-amber-500/20 to-red-500/20",
    },
    {
      title: "Interactive & Immersive Experiences",
      description:
        "We don't just create static designs. Our team crafts interactive experiences with multi-layered content that invites your audience to explore and engage deeply with your material.",
      image1:
        "https://www.salonemilano.it/sites/default/files/styles/libero/public/images/articles/2021-05/Ritratti-Grafici_H_zaven.jpg.webp?itok=EeRh1pqL",
      image2:
        "https://freight.cargo.site/t/original/i/587128be50257705bbec00fae313586a7de6e4bd842469e535c3773ab63de0ef/MUR_4.png",
      color: "from-emerald-500/20 to-cyan-500/20",
    },
    {
      title: "Bespoke Creative Solutions",
      description:
        "Every client receives a completely custom approach. We create tailor-made visual systems that align perfectly with your brand voice, objectives, and audience expectations.",
      image1:
        "https://cdn.dribbble.com/userupload/43106802/file/original-866775ba1aff2a90974437b30f22ee82.png?resize=1504x1128&vertical=center",
      image2:
        "https://www.northeastshop.com/cdn/shop/products/7_8a8135c0-3100-4db9-a8e7-c26293be50e5.jpg?v=1680943307&width=1920",
            ...
            >
              ...
              <div className="relative px-8 pt-8 pb-4 border-b border-gray-100 dark:border-gray-800">
                ...
                <p className="text-gray-500 dark:text-gray-400 mt-1">
                  Leading Innovators in Visual Communication & Design
                </p>
              </div>
                  ...
                  <div className="col-span-12 md:col-span-3">
                    <div className="space-y-3">
                      {modalSections.map((section, index) => (
                        ...
                        >
                          <p
                            className={`font-medium ${activeSection === index ? "text-primary" : "text-gray-700 dark:text-gray-300"}`}
                          >
                  ...
                  <div className="col-span-12 md:col-span-9">
                    <div className="relative overflow-hidden">
                      ...
                      <div className={`bg-gradient-to-br ${modalSections[activeSection].color} p-6 rounded-2xl`}>
                        ...
                        <p className="text-gray-700 dark:text-gray-300 mb-6">
                          {modalSections[activeSection].description}
                        </p>
                        ...
                        <div className="grid grid-cols-12 gap-4 mt-4">
                          ...
                          <div className="col-span-12 md:col-span-8 rounded-lg overflow-hidden shadow-lg relative group">
                            <div className="relative w-full h-64">
                              <img
                                src={modalSections[activeSection].image1 || "/placeholder.svg"}
                                alt="Design example"
                          ...
                          <div className="col-span-12 md:col-span-4 space-y-4">
                            <div className="rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                              <div className="relative w-full h-28">
                                <img
                                  src={modalSections[activeSection].image2 || "/placeholder.svg"}
                                  alt="Design example"
                            ...
                            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-3 rounded-lg border border-gray-100 dark:border-gray-700 shadow-sm">
                              ...
                              <p className="text-xs text-gray-600 dark:text-gray-400">
                                "Pan Eura transformed our complex technical content into visually stunning, accessible
                                materials that increased reader engagement by 78%."
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-100 dark:border-purple-800/30">
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-400">
                          Understanding your unique vision and requirements
                        </p>
                      </div>
                      <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800/30">
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-400">
                          Creating visual systems that communicate your message
                        </p>
                      </div>
                      <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-100 dark:border-amber-800/30">
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-400">
                          Building interactive and engaging content experiences
                        </p>
                      </div>
                      <div className="p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-100 dark:border-emerald-800/30">
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-400">
                          Finalizing and implementing your visual masterpiece
                        </p>
                      </div>
                    </div>
                  </div>
